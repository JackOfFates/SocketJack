...
public static class SecurityProtocol {
    ...
    public const string OfficialPipeName = "heirowLLM.Workstation.Security.v1";
    public const string DevelopmentPipeName = "heirowLLM.Workstation.Security.Development.v1";
...
public sealed class PortableRecoveryFile {
    public string Format { get; set; } = "heirowLLM Workstation Recovery Key";
