...
public static class PortableRecovery {
    ...
    public static string Create(string recoveryKey) {
        ...
        try {
            ...
            aes.Encrypt(nonce, plain, cipher, tag, "heirowLLM-Recovery-v1"u8);
    ...
    public static bool Validate(string? recoveryKey, string? encodedEnvelope) {
        try {
            ...
            try {
                ...
                aes.Decrypt(Convert.FromBase64String(envelope.Nonce), cipher, Convert.FromBase64String(envelope.Tag), plain, "heirowLLM-Recovery-v1"u8);
