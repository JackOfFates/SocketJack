...
using heirowLLM.SecurityBroker;
...
const string brokerMutexName = @"Global\SocketJack.heirowLLM.SecurityBroker.Official.v1";
Mutex? brokerMutex;
try {
...
builder.Services.AddWindowsService(options => options.ServiceName = "heirowLLM Security Broker");
try {
