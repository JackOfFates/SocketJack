...
[TestClass]
public sealed class HeirowLlmGitHubRepoImportTests
{
    [DataTestMethod]
    ...
    {
        MethodInfo method = typeof(HeirowLlm).GetMethod("TryNormalizeGitHubRepositoryInput", BindingFlags.NonPublic | BindingFlags.Static)
    ...
    {
        MethodInfo method = typeof(HeirowLlm).GetMethod("StripGitHubArchiveWrapperPath", BindingFlags.NonPublic | BindingFlags.Static)
    ...
    {
        MethodInfo method = typeof(HeirowLlm).GetMethod("FormatGitHubRepositoryTooLargeMessage", BindingFlags.NonPublic | BindingFlags.Static)
