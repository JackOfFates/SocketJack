...
[TestClass]
public sealed class HeirowLlmRoutingTests
{
    [TestMethod]
    public void CopilotDuplicatorRemoteRouting_OverridesLocalRuntimeProvider()
    {
        ...
        {
            LocalModelRuntime = new HttpHeirowLlmModelRuntime("Embedded LlmRuntime", "http://127.0.0.1:1234")
        };
    ...
    public void PrepareModelRuntimeForwardBody_StripsLmStudioUnsupportedLoadFields()
    {
        ...
        string sanitized = HeirowLlm.PrepareModelRuntimeForwardBody("/api/v1/models/load", body, "LM Studio");
    ...
    public void PrepareModelRuntimeForwardBody_MapsUnloadAliasWhenModelKeyIsMissing()
    {
        ...
        string forwarded = HeirowLlm.PrepareModelRuntimeForwardBody("/api/v1/models/unload", body, "LM Studio");
    ...
    public void PrepareModelRuntimeForwardBody_KeepsEmbeddedLlmRuntimeLoadFields()
    {
        ...
        string forwarded = HeirowLlm.PrepareModelRuntimeForwardBody("/api/v1/models/load", body, "LlmRuntime");
    ...
    {
        using var proxy = new HeirowLlm("localhost", 11435, 18080, 18081);
        var method = typeof(HeirowLlm).GetMethod("RuntimeModelIdMatches", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
