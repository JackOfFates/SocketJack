...
namespace SocketJack.Net {
    public sealed class HeirowLlmServerProfile {
        ...
        public long StorageLimitMegabytes { get; set; } = 10240;
        ...
        public HeirowLlmServerProfile Clone() {
            return new HeirowLlmServerProfile {
                ServerId = ServerId ?? "",
        ...
        public void Normalize(string defaultServerName) {
            ...
            if (string.IsNullOrWhiteSpace(ServerName))
                ServerName = string.IsNullOrWhiteSpace(defaultServerName) ? "HeirowLlm Host" : defaultServerName.Trim();
