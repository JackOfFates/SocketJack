...
namespace SocketJack.Net
{
    public partial class LmVsProxy
    {
        ...
        private sealed class LocalAgentBuilderAgentRunner : IAgentBuilderAgentRunner
        {
            ...
            public LocalAgentBuilderAgentRunner(LmVsProxy proxy, NetworkConnection connection, HttpRequest sourceRequest)
            {
                _proxy = proxy;
        ...
        private object RunLocalAgentBuilderPrompt(NetworkConnection connection, HttpRequest sourceRequest, AgentBuilderNode node, string prompt, CancellationToken cancellationToken)
        {
            ...
            var request = new HttpRequest
            {
                ...
                Body = JsonSerializer.Serialize(new { prompt, model, selectedService = "chat", service = "chat", messages = new[] { new { role = "user", content = prompt } } })
            };
