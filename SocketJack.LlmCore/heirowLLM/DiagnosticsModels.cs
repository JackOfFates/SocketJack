...
namespace heirowLLM
{
    ...
    public sealed class ChatWorkspaceRootSnapshot
    {
        ...
        public bool IsProjectInherited { get; set; }
    ...
    public sealed class ChatClientPermissionSnapshot
    {
        ...
        public bool PictureBank { get; set; } = true;
    ...
    public sealed class ProjectVersionControlVersionSnapshot
    {
        ...
        public long StorageBytes { get; set; }
        public List<ProjectVersionControlFileChangeSnapshot> Changes { get; set; } = new List<ProjectVersionControlFileChangeSnapshot>();
    }

    public sealed class ProjectVersionControlFileChangeSnapshot
    {
