...
public sealed class MobileDiagnosticsPage : ContentPage
{
    ...
    public MobileDiagnosticsPage(HeirowLlmClient client, bool showUsers = false)
    {
        _client = client;
    ...
    private async Task CopyAsync()
    {
        ...
        await Clipboard.Default.SetTextAsync($"heirowLLM diagnostics {_snapshot.GeneratedUtc}\nHealth: {_snapshot.Health.Tier} ({_snapshot.Health.Score:0.#})\n{events}");
