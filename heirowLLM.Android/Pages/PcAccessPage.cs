...
public sealed class PcAccessPage : ContentPage
{
    ...
    public PcAccessPage(ServerInfo server, HeirowLlmClient client)
    {
        _server = server;
        _client = client;
        Title = "PC Access";
    ...
    {
#if ANDROID
        if (_video.Handler?.PlatformView is heirowLLM.Mobile.Platforms.Android.TextureVlcView nativeVideo)
        {
