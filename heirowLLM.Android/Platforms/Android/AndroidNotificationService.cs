...
{
    internal const string ActiveChannelId = "heirowllm_generation";
    internal const string AlertChannelId = "heirowllm_responses";
    internal const int ActiveNotificationId = 41001;
    internal const int AlertNotificationId = 41002;
    internal const string ActionStart = "com.socketjack.heirowllm.mobile.GENERATION_START";
    internal const string ActionStop = "com.socketjack.heirowllm.mobile.GENERATION_STOP";
    internal const string ExtraServerKey = "heirowllm_server_key";
    internal const string ExtraSessionId = "heirowllm_session_id";
    private const string UnreadKey = "heirowllm.mobile.notifications.unread";
    private const string LatestServerKey = "heirowllm.mobile.notifications.latestServer";
    ...
    public void NotifyThinkingCompleted(string serverKey, string sessionId)
    {
        ...
        new AndroidChickenChaserOverlayService().SetNotificationDot(true);
        ...
        builder.SetContentTitle("heirowLLM Mobile");
    ...
    public void ResetUnread()
    {
        ...
        new AndroidChickenChaserOverlayService().SetNotificationDot(false);
    ...
    internal static void EnsureChannels(Context context)
    {
        ...
        {
            Description = "Quiet status while heirowLLM Mobile is generating a response"
        };
...
[Service(
    Name = "com.socketjack.heirowllm.mobile.GenerationForegroundService",
    Exported = false,
