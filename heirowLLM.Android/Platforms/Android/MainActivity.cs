...
public class MainActivity : MauiAppCompatActivity
{
    ...
    protected override void OnResume()
    {
        ...
        _ = Resolve<IChickenChaserOverlayService>()?.EnableAsync();
    }
    ...
    {
        if (intent?.GetBooleanExtra("open_chicken_chaser", false) == true)
        {
            Resolve<ChickenChaserOverlayNavigationService>()?.QueueOpen();
            intent.RemoveExtra("open_chicken_chaser");
        }
