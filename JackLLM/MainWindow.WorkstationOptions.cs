...
public partial class MainWindow
{
    ...
    private List<WorkstationOptionBinding> BuildWorkstationOptionBindings()
    {
        ...
        var defaults = new JackLLMSettings();

        foreach (PropertyInfo property in typeof(JackLLMSettings).GetProperties(BindingFlags.Public | BindingFlags.Instance)
                     .OrderBy(property => property.Name, StringComparer.OrdinalIgnoreCase))
        {
            ...
            bool editable = property.SetMethod?.IsPublic == true && !sensitive &&
                            !string.Equals(property.Name, nameof(JackLLMSettings.ServicePropertyOverrides), StringComparison.Ordinal);
            ...
            var option = new WorkstationOptionDto
            {
                ...
                Category = CategorizeWorkstationSetting(property.Name),
                ...
                Description = BuildWorkstationOptionDescription(property.Name, "Workstation settings", editable, sensitive),
